...
class CIFAR_Dataset10(Dataset):
    def __init__(self,data_dir,train,transform):
        ...
        if self.train:
            for i in range(5):
                with open(data_dir+"cifar-10-batches-py/data_batch_"+str(i+1),'rb') as f:
...
if __name__ == "__main__":
    ...
    config.seed = 2222
    config.log_dir = get_project_path()+"/replay_logs/icarl/"
    config.log_file_name = "icarl_cifar10_mixup.txt"
