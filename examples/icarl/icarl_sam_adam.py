...
from avalanche.training.plugins.early_stopping import EarlyStoppingPluginForTrainMetric
...
def run_experiment(config, args):
    ...
    early_stopping = EarlyStoppingPluginForTrainMetric(patience=15)
...
if __name__ == "__main__":
    ...
    config.seed = 2222
    config.log_dir = get_project_path() + "train_logs/icarl_loggers/{}-early.txt".format(args.opt)
