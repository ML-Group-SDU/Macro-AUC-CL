...
parser.add_argument('--cuda_device', type=int, default=2, help='Cuda device identifier')
...
parser.add_argument('--epochs', type=int, default=50, help='Number of epochs per task (base learning)',
...
def load_dataset(dataset: str, force_unique_task: bool = False) -> Tuple[NCScenario, NCScenario]:
    if dataset in ['mnist', 'usps', 'omniglot']:
        ...
        transforms = T.Compose([T.ToPILImage(),T.Grayscale(3), T.Resize((224, 224)), T.ToTensor()])
