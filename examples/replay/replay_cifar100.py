...
def main(args):
    ...
    model = ResNet34(num_classes=10) if args.scenario == 'task' or args.scenario=="domain" else ResNet34(num_classes=100) if args.scenario == 'class' else None
    ...
    cl_strategy = Naive(
        ...
        eval_mb_size=100,
        device=device,
        plugins=[ReplayPlugin(mem_size=args.mem_size), sched],
