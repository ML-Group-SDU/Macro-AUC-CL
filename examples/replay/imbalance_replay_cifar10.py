...
def main(args):
    ...
    model = ResNet18(num_classes=2) if (args.scenario == 'task' or args.scenario == 'domain') else ResNet18(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cuda", type=int, default=3, help="Select zero-indexed cuda device. -1 to use CPU.", )
    ...
    parser.add_argument('--mixup', type=str, default='yes', help="whether or not to use mixup")
