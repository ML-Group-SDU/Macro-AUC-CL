...
from avalanche.models import SwinTransformerSelf,VisionTransformerB16
...
def main(args):
    ...
    model = SwinTransformerSelf(num_classes=2) if (args.scenario == 'task' or args.scenario == 'domain') else SwinTransformerSelf(num_classes=10) if args.scenario == 'class' else None
