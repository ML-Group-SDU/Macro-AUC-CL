...
from avalanche.training.plugins import MomentumPlugin, LRSchedulerPlugin, EarlyStoppingPluginForTrainMetric
...
def main(args):
    ...
    model = ResNet34(num_classes=10) if args.scenario == 'task' or args.scenario == "domain" else ResNet34(
        num_classes=200) if args.scenario == 'class' else None
