...
from avalanche.training.plugins import EvaluationPlugin, LRSchedulerPlugin, OCDMPlugin
...
from avalanche.evaluation.multilabel_metrics.multiLabelLoss import MultiSoftLoss
...
def main(args):
    ...
    if args.opt == "sgd":
        ...
        plugin = [sched, OCDMPlugin(mem_size=args.mem_size)]
    else:
        plugin = [OCDMPlugin(mem_size=args.mem_size)]
