...
from avalanche.training import MultiLabelNaive,Naive
...
from avalanche.evaluation.multilabel_metrics.multiLabelLoss import SpecficBCELoss,ReweightedMarginLoss
...
def main(args):
    ...
    elif args.crit == "ReWeightedMargin":
        crit = ReweightedMarginLoss()
