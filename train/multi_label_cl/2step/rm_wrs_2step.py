...
from avalanche.evaluation.multilabel_metrics.multiLabelLoss import ReweightedMarginLoss, ReweightedLoss
...
def main(args):
    ...
    if args.opt == "sgd":
        ...
        plugin = [sched,MultiLabelReplayPlugin(mem_size=args.mem_size,with_wrs=args.with_wrs)]
    else:
        plugin = [MultiLabelReplayPlugin(mem_size=args.mem_size,with_wrs=args.with_wrs)]
