...
class ReplayPlugin(SupervisedPlugin):
    ...
    def before_training_exp(
        ...
        **kwargs
        ...
        if strategy.scenario_mode == 'task' or strategy.scenario_mode == "domain":
            classes_in_this_experience = strategy.experience.classes_in_this_experience
            class_num = len(classes_in_this_experience)
        elif strategy.scenario_mode == 'class':
            sofar = strategy.experience.classes_seen_so_far
            future_class = strategy.experience.future_classes
            class_num = len(sofar) + len(future_class)
        else:
            print("Not set scenario mode")
            sofar = strategy.experience.classes_seen_so_far
            future_class = strategy.experience.future_classes
            class_num = len(sofar) + len(future_class)
