...
from avalanche.benchmarks.utils.data_loader import MultiLabelReplayDataLoader
from avalanche.training.plugins.strategy_plugin import SupervisedPlugin
from avalanche.training.storage_policy import (
    ExemplarsBuffer,
    ExperienceBalancedBuffer,
    MultiLabelExperienceBalancedBuffer
)
...
class MultiLabelReplayPlugin(SupervisedPlugin):
    ...
    def __init__(
        ...
        if storage_policy is not None:  # Use other storage policy
            ...
            # )
            self.storage_policy = MultiLabelExperienceBalancedBuffer(
                max_size=self.mem_size, adaptive_size=True
            )
