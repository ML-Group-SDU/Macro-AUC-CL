...
from avalanche.evaluation.multilabel_metrics import SpecficBCELoss
...
class BaseSGDTemplate(BaseTemplate):
    ...
    **Evaluation loop**
    ...
    def __init__(
        ...
        self._criterion2 = SpecficBCELoss()
        """ Criterion. """
    ...
    def make_train_dataloader(
        ...
        **kwargs
        ...
        try:
            total_class_num = self.experience.benchmark.n_classes
    ...
    def make_eval_dataloader(
        ...
        collate_from_data_or_kwargs(self.adapted_dataset,
                                    other_dataloader_args)
        print("make_eval_dataloader: num_workers: ", num_workers)
...
class PeriodicEval(SupervisedPlugin):
    ...
    def before_training(self, strategy, **kwargs):
        ...
        training.
        """
        print("do_initial: ", self.do_initial)
        print("-------------------------------------------------------------------------------------------")
        if self.do_initial:
