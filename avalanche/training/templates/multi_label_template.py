...
class MultiLabelSupervisedTemplate(BatchObservation, MultiLabelSupervisedProblem, SGDUpdate,
                         BaseSGDTemplate):
...
class NaiveMarginSupervisedTemplate(BatchObservation, MarginNaiveSupervisedProblem, SGDUpdate,
                         BaseSGDTemplate):
    """Base class for continual learning strategies.
